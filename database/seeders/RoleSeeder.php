...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'persons.create'])->syncRoles([$role1]);
        Permission::create(['name' => 'persons.edit'])->syncRoles([$role1]);
        Permission::create(['name' => 'persons.show'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'persons.destroy'])->syncRoles([$role1]);

        Permission::create(['name' => 'transactions.index'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'transactions.create'])->syncRoles([$role1]);
        Permission::create(['name' => 'transactions.edit'])->syncRoles([$role1]);
        Permission::create(['name' => 'transactions.show'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'transactions.destroy'])->syncRoles([$role1]);

        Permission::create(['name' => 'projects.index'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'projects.create'])->syncRoles([$role1]);
        Permission::create(['name' => 'projects.edit'])->syncRoles([$role1]);
